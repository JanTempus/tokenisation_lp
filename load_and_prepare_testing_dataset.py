...
firstHalf = int(dataSetSize/2)

for i in range(firstHalf,dataSetSize):
...
file_name= "word_freqs_testing"+str(dataSetSize)+".pkl"
...
np.savez("strings_with_frequency_testing.npz", inputStrings=np.array(inputStrings), inputStringsfrequencies=np.array(inputStringsfrequencies))